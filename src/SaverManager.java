...
public class SaverManager {
    ...
    public String readInvestors(int id) {
        StringBuilder string = new StringBuilder();
        try (BufferedReader br = new BufferedReader(new FileReader(storagePath))) {
    ...
    public String readCompanies(int id) {
        StringBuilder string = new StringBuilder();
        try (BufferedReader br = new BufferedReader(new FileReader(storagePath))) {
            br.readLine();
            string.append(br.readLine());
    ...
    public String readActions(int id) {
        StringBuilder string = new StringBuilder();
        try (BufferedReader br = new BufferedReader(new FileReader(storagePath))) {
            br.readLine();
            br.readLine();
